...
const stories = [
  ...
  },
  {
    ...
    oneMinuteSections: {
      ...
      "A | Action": "I took a step-by-step approach. I started by upgrading the system before the launch instead of refactoring everything at once. I kept the business logic unchanged and gradually migrated the code to Vue 3. Then, I reorganized the page structure, improved CI/CD, and extracted repeated sections into shared components. After the launch, I introduced TypeScript step by step to avoid making too many changes at once.",
    ...
    fullSections: {
      ...
      "A | Action": "I took a step-by-step approach. I started by upgrading the system before the launch instead of refactoring everything at once. I kept the existing business logic unchanged and gradually migrated the code to Vue 3. Then, I reorganized the page structure to improve readability and maintainability. I also improved the CI/CD process to make testing and deployment more stable. As the migration progressed, I gradually extracted repeated sections into shared components. After the launch, I introduced TypeScript step by step so that we could avoid making too many changes at once.",
    ...
    sample:
      "When I joined the company, I took over a language learning platform that was expected to be Vue 3 but was actually still using Vue 2. The structure was messy, Vue 2 was no longer officially maintained, and the project had to launch in three months. We had to decide whether to upgrade before or after the launch, and I recommended upgrading before launch to reduce future technical risk. I took a step-by-step approach. I started by upgrading the system before the launch instead of refactoring everything at once. I kept the business logic unchanged and gradually migrated the code to Vue 3. Then, I reorganized the page structure, improved CI/CD, and extracted repeated sections into shared components. After the launch, I introduced TypeScript step by step to avoid making too many changes at once. We completed the migration and refactoring within six months and made the project easier to maintain.",
    fullSample:
      "When I joined the company, I worked on a language learning platform. Before I joined, I was told that it was a Vue 3 project. However, after I took over the project, I found that it was still using Vue 2. At that time, Vue 2 was no longer officially maintained. The website structure was also messy, with very little componentization. The project was scheduled to launch in three months. We had two options: upgrade it immediately or upgrade it after the launch. Based on my past experience, it is usually difficult to find time to go back and fix the architecture after a product is launched. Therefore, I needed to reduce the technical risk and complete the migration step by step without affecting the business logic or the launch schedule. I took a step-by-step approach. I started by upgrading the system before the launch instead of refactoring everything at once. I kept the existing business logic unchanged and gradually migrated the code to Vue 3. Then, I reorganized the page structure to improve readability and maintainability. I also improved the CI/CD process to make testing and deployment more stable. As the migration progressed, I gradually extracted repeated sections into shared components. After the launch, I introduced TypeScript step by step so that we could avoid making too many changes at once. Finally, I completed the Vue 3 migration and the architecture refactoring within six months. I also changed the project from a non-componentized structure to one that was easier to maintain and extend. This experience taught me that for a legacy system with a tight deadline, a step-by-step migration can balance the product launch and technical quality better than a full rewrite."
  },
  {
    id: "language",
    number: "03",
