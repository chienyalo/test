...
const stories = [
  {
    ...
    fullSections: {
      ...
      "T | Task": "My role was to develop the frontend and help the team narrow down the requirements and define a deliverable MVP. Because the systems had to go live within one year, we needed to make trade-offs between feature value, development cost, and the schedule.",
